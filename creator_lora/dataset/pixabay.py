...
def pixabay_api_request(api_key, query, lang="en", image_type="all", orientation="all", category=None,
                        min_width=0, min_height=0, colors=None, editors_choice=False, safesearch=False,
                        order="popular", page=1, per_page=20, callback=None, pretty=False):
